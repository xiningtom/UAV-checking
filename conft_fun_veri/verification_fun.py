...
def verification(fun_list):
    ...
    path = r'../../Project/'+line+'/pilot_src/Source/Src/'
    path1=os.path.abspath(path)
    ...
    temp_command = temp_command + "-I../Inc --32 --function "

    unwind = " --unwind 1 --partial-loops --no-unwinding-assertions"
    os.chdir(path)
...
def main():
    ...
    path1 = r'../../Project/'+pro_name+'/pilot_src/Source/Src/'+filename
